...
function QuickActions() {
  const actions = [
    { label: 'New Sale', icon: CreditCard, href: '/pos', color: 'var(--fp-amber)' },
    { label: 'Add Customer', icon: Users, href: '/customers', color: 'var(--fp-info)' },
    { label: 'Add Product', icon: Package, href: '/products', color: 'var(--fp-success)' },
    { label: 'Gift Cards', icon: Gift, href: '/gift-cards', color: '#8b5cf6' },
    { label: 'Promotions', icon: Star, href: '/promotions', color: 'var(--fp-amber-dark)' },
    { label: 'Analytics', icon: BarChart3, href: '/analytics', color: 'var(--fp-navy)' },
  ];
